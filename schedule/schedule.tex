...
\TextSize{\bf}
\begin{schedule}[SEA-EU School on Computational Mathematics. \it\bfseries Split, September 9-13, 2024]
  ...
  % Lectures
  \talk{Lecture 1}{\lecturer{Hermenegildo Borges de Oliveira}}{M}{\tLecturesOne-\tCoffeeTwo}
  \talk{Lecture 2}{\lecturer{Karolina Kropielnicka}}{M}{\tLecturesTwo-\tExercises}
  \talk{Lecture 3}{\lecturer{M. Conepción Muriel Patino}}{T}{\tLecturesOne-\tCoffeeTwo}
  \talk{Lecture 4}{\lecturer{Andrijana Curkovic}}{T}{\tLecturesTwo-\tExercises}
  \talk{Lecture 5}{\lecturer{Saša Krešić-Jurić}}{Th}{\tLecturesOne-\tCoffeeTwo}
